...
module.exports = class player {
    constructor(data) {
        ...
        if (this.user_id === 22813) {
            this.relationship_status = 'm';
            this.relationship_with_id = 22815;
            this.relationship_with_rank = 26;
            this.relationship_with_photo = 'https://image.prntscr.com/image/akT_bwuLT0_1Yl-EAS-vnA.png';
            this.relationship_with_name = 'Atenea';
